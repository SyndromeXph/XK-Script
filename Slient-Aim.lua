...
local repo = "https://raw.githubusercontent.com/SyndromeXph/Obsidian-XK/refs/heads/main/"
...
local Window = Library:CreateWindow({ Title = "通用静默瞄准", Footer = "XK HUB", Center = true, AutoShow = true })
